...
export async function bokunRequest<T = unknown>({
    ...
    const accessKey = env.BOKUN_ENVIRONMENT == 'DEV' ? env.BOKUN_ACCESS_KEY : env.BOKUN_ACCESS_KEY_PROD ;
    const secretKey =  env.BOKUN_ENVIRONMENT == 'DEV' ? env.BOKUN_SECRET_KEY : env.BOKUN_SECRET_KEY_PROD ;
